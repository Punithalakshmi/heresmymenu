...
//Main Action Hooks
add_action( 'admin_menu', 'fro_add_admin_menu' );
add_action( 'admin_init', 'fro_settings_init' );

function fro_add_admin_menu() { 
	
	add_menu_page( 'LazyEater Settings', 'LazyEater', 'manage_options', 'lazyeater', 'fro_options_page', plugins_url( 'assets/imgs/admin_icon.png', lAZY_EATER_FILE ), 11 );
...
function fro_settings_init() {

	register_setting( 'lazyeater_page_general', 'fro_settings' );
	register_setting( 'lazyeater_page_withdraw', 'fro_settings' );
	register_setting( 'lazyeater_page_fees', 'fro_settings' );
	register_setting( 'lazyeater_page_tos', 'fro_settings' );

	do_action('frozr_before_lazyeater_options');
	
	// Sections
	add_settings_section(
		'fro_general_options_section',
		__( 'General Settings', 'frozr' ),
		'',
		'lazyeater_page_general');

	add_settings_section(
		'fro_withdraw_options_section',
		__( 'Withdraw Settings', 'frozr' ),
		'',
		'lazyeater_page_withdraw');

	add_settings_section(
		'fro_fees_options_section',
		__( 'Fees/Commission Settings', 'frozr' ),
		'',
		'lazyeater_page_fees');

	add_settings_section(
		'fro_tos_options_section',
	...
	// General Settings
	add_settings_field( 
		'fro_lazy_auto_updates',
		__( 'Enable Auto updates for LazyEater?', 'frozr' ), 
		'fro_lazy_auto_updates_render',
		'lazyeater_page_general',
		'fro_general_options_section' );

	add_settings_field( 
		'fro_allow_user_admin_access',
		__( 'Allow Sellers to Access Admin Panel?', 'frozr' ),
		'fro_allow_user_admin_access_render',
		'lazyeater_page_general',
		'fro_general_options_section' );

	add_settings_field( 
		'fro_new_seller_status',
		__( 'Auto Enable Selling on Restaurant Registration?', 'frozr' ),
		'fro_new_seller_status_render',
		'lazyeater_page_general',
		'fro_general_options_section' );
	
	// REMOVE Backwards Compatibility
	add_settings_field( 
		'fro_general_percentage',
		__( 'General seller commission percentage.', 'frozr' ),
		'fro_general_percentage_render',
		'lazyeater_page_general',
		'fro_general_options_section' );
	...
	// Withdraws
	add_settings_field( 
		'fro_minimum_withdraw_balance',
		__( 'The Minimum user balance to make a withdraw.', 'frozr' ), 
		'fro_minimum_withdraw_balance_render',
		'lazyeater_page_withdraw',
		'fro_withdraw_options_section' );

	add_settings_field( 
		'fro_withdraw_methods',
		__( 'Withdraw Methods.', 'frozr' ),
		'fro_withdraw_methods_render',
		'lazyeater_page_withdraw',
		'fro_withdraw_options_section' );

	add_settings_field( 
		'fro_withdraw_order_status',
		__( 'Withdraw Request Status.', 'frozr' ),
		'fro_withdraw_order_status_render',
		'lazyeater_page_withdraw',
		'fro_withdraw_options_section' );
...
// REMOVE Backwards Compatibility
function fro_general_percentage_render() { 
	?>
	<span class="frozr_depreciated_option"><?php echo __('This option is no more used since 1.1. Click on the "Fees/Commission" tab to use the new options.','frozr'); ?></span>
	<?php
}

function fro_lazy_fees_render() {
	$option = get_option( 'fro_settings' );
	$fees_options = (! empty( $option['fro_lazy_fees']) ) ? $option['fro_lazy_fees'] : '';
	$fees_count = 0;
	...
	foreach ($args_vals as $rule) {
		...
		echo "<tr class=\"$field_label\">";
			...
			if ($field_label == "customers_effected") {
				frozr_wp_select(array("id" => "fro_settings[fro_lazy_fees][$array_count][$field_label]", "class" => "", "value" => $field_value, "options" => $customers_effected_options ));
			} elseif ($field_label == "sellers_effected") {
				frozr_wp_select(array("id" => "fro_settings[fro_lazy_fees][$array_count][$field_label]", "class" => "", "value" => $field_value, "options" => $sellers_effected_options ));
			} elseif ($field_label == "sellers") {
				frozr_wp_select(array("id" => "fro_settings[fro_lazy_fees][$array_count][$field_label]", "class" => "", "value" => $field_value, "options" => frozr_get_all_sellers(), "custom_attributes" => array("multiple" => "multiple", "required" => "required") ));
			} elseif ($field_label == "customers") {
				frozr_wp_select(array("id" => "fro_settings[fro_lazy_fees][$array_count][$field_label]", "class" => "", "value" => $field_value, "options" => frozr_get_all_customers(), "custom_attributes" => array("multiple" => "multiple", "required" => "required") ));
			} elseif ($field_label == "amount_effect") {
				frozr_wp_select(array("id" => "fro_settings[fro_lazy_fees][$array_count][$field_label]", "class" => "", "value" => $field_value, "options" => $amount_effected_options ));
			} else {
				frozr_wp_text_input(array("id" => "fro_settings[fro_lazy_fees][$array_count][$field_label]", "class" => "", "value" => $field_value, "type" => $input_type, "data_type" => $data_type, "custom_attributes" => array($required, "step" => $step, "min" => $min) ));
			}
			echo '</td>';
		echo '</tr>';
		}
...
function fro_reco_sellers_render() { 

	$option = get_option( 'fro_settings' );
	$options = (! empty( $option['fro_reco_sellers']) ) ? $option['fro_reco_sellers'] : array('0');
	...
	<select name='fro_settings[fro_reco_sellers][]' multiple="multiple">
...
function fro_lazy_auto_updates_render() { 

	$option = get_option( 'fro_settings' );
	$options = (! empty( $option['fro_lazy_auto_updates']) ) ? $option['fro_lazy_auto_updates'] : 0;
	?>
	<input type='checkbox' name='fro_settings[fro_lazy_auto_updates]' <?php checked( $options, 1 ); ?> value='0'>
	<?php
}

function fro_allow_user_admin_access_render() { 

	$option = get_option( 'fro_settings' );
	$options = (! empty( $option['fro_allow_user_admin_access']) ) ? $option['fro_allow_user_admin_access'] : 0;
	?>
	<input type='checkbox' name='fro_settings[fro_allow_user_admin_access]' <?php checked( $options, 1 ); ?> value='1'>
	<?php
}

function fro_new_seller_status_render() { 

	$option = get_option( 'fro_settings' );
	$options = (! empty( $option['fro_new_seller_status']) ) ? $option['fro_new_seller_status'] : 0;
	?>
	<input type='checkbox' name='fro_settings[fro_new_seller_status]' <?php checked( $options, 1 ); ?> value='1'>
	<?php
}

function fro_minimum_withdraw_balance_render() { 

	$options = get_option( 'fro_settings' );
	?>
	<input type='number' name='fro_settings[fro_minimum_withdraw_balance]' value='<?php echo (! empty( $options['fro_minimum_withdraw_balance'])) ? $options['fro_minimum_withdraw_balance'] : 50; ?>'>
	<?php
}

function fro_tos_sellers_render() { 
	...
	<textarea name="fro_settings[fro_tos_sellers]" class="fro_tos"><?php echo $options['fro_tos_sellers']; ?></textarea>
	<?php
}

function fro_tos_customers_render() { 
	...
	<textarea name="fro_settings[fro_tos_customers]" class="fro_tos"><?php echo $options['fro_tos_customers']; ?></textarea>
	<?php
}

function fro_withdraw_methods_render() { 

	$option = get_option( 'fro_settings');
	$option_array = ( is_array( $option['fro_withdraw_methods']) ) ? $option['fro_withdraw_methods'] : array($option['fro_withdraw_methods']);
	...
	<select name="fro_settings[fro_withdraw_methods][]" multiple="multiple">
...
function fro_withdraw_order_status_render() { 

	$option = get_option( 'fro_settings' );
	$options = (! empty( $option['fro_withdraw_order_status']) ) ? $option['fro_withdraw_order_status'] : 'pending';
	?>
	<select name='fro_settings[fro_withdraw_order_status]'>
	...
	<div class="wrap lazyeater">
		<form method="<?php echo esc_attr( apply_filters( 'lazyeater_settings_form_method_tab_' . $current_tab, 'post' ) ); ?>" id="mainform" action="options.php" enctype="multipart/form-data">
			...
			<?php
				...
				do_settings_fields( 'lazyeater_page_fees', 'fro_fees_options_section' );
...
// Customizer options
function eater_options ($wp_customize) {
	...
	$wp_customize->add_control( new Add_class ( $wp_customize, 'fro_show_rest_adv_search', array('label' => __( "Show Restaurant Search Section?", "frozr"),'section' => 'rest_adv_search','settings' => 'show_rest_adv_search', 'sclass' => 'fro_checkbox_option', 'fro_attrs' => array('data-amount'=>'11'), 'active_callback' => 'is_front_page','type' => 'checkbox')));
	fro_background_bund( $wp_customize, 'Section ', 'rest_adv_search', 'is_front_page', '', 'rads_bg_color', 'rads_bg_image', 'rads_bg_repeat', 'rads_bg_position', 'rads_bg_attachment', '#725827');
	...
	$wp_customize->add_control( new Add_class ( $wp_customize,'fro_rest_adv_filter_accord', array('label' => __( ' Search Filters Options', 'frozr'),'section' => 'rest_adv_search','settings' => 'rest_adv_filter_accord','sclass'=>'adv_options','adv'=>true,'fro_attrs'=>array('data-amount'=>'16'),'active_callback' => 'is_front_page')));	
	...
	$wp_customize->add_control( new Add_class ( $wp_customize, 'fro_show_rest_adv_filter_accord', array('label' => __( "Show Restaurant Search Filters Section?", "frozr"),'section' => 'rest_adv_search','settings' => 'show_rest_adv_filter_accord', 'sclass' => 'fro_checkbox_option', 'fro_attrs' => array('data-amount'=>'12'), 'active_callback' => 'is_front_page','type' => 'checkbox')));
	fro_background_bund( $wp_customize, 'Filters Section ', 'rest_adv_search', 'is_front_page', '', 'radfs_bg_color', 'radfs_bg_image', 'radfs_bg_repeat', 'radfs_bg_position', 'radfs_bg_attachment', '#f89d1a');
	...
	$wp_customize->add_control( new WP_Customize_Color_Control ( $wp_customize,'fro_rest_adv_filters_ty_color', array('label' => __( 'Search Filters Titles Color', 'frozr' ),'section' => 'rest_adv_search','settings' => 'rest_adv_filters_ty_color','active_callback' => 'is_front_page')));
	//Top Selling items
	...
	$wp_customize->add_control( new Add_class ( $wp_customize, 'fro_show_top_dishes', array('label' => __( "Show Top Selling Items?", "frozr"),'section' => 'top_selling_dish','settings' => 'show_top_dishes', 'sclass' => 'fro_checkbox_option', 'fro_attrs' => array('data-amount'=>'23'), 'active_callback' => 'is_front_page','type' => 'checkbox')));
	...
	$wp_customize->add_control( 'fro_top_dish_loop_title', array('label' => __( "Loop title", "frozr"),'section' => 'top_selling_dish','settings' => 'top_dish_loop_title','active_callback' => 'is_front_page'));
	...
	$wp_customize->add_control( 'fro_top_dish_desc', array('label' => __( "Loop description", "frozr"),'section' => 'top_selling_dish','settings' => 'top_dish_desc','active_callback' => 'is_front_page'));
	...
	$wp_customize->add_control( new Add_class ( $wp_customize,'fro_top_dish_lyt_accord', array('label' => __( ' Layout Options', 'frozr'),'section' => 'top_selling_dish','settings' => 'top_dish_lyt_accord','sclass'=>'adv_options','adv'=>true,'fro_attrs'=>array('data-amount'=>'8'),'active_callback' => 'is_front_page')));	
	fro_background_bund($wp_customize, 'Loop', 'top_selling_dish', 'is_front_page', '', 'top_dish_bg_color', 'top_dish_bg_image', 'top_dish_bg_repeat', 'top_dish_bg_position', 'top_dish_bg_attchment');
	...
	$wp_customize->add_control( 'fro_top_dish_border', array('label' => __( "Show the loop top border", "frozr"),'section' => 'top_selling_dish','settings' => 'top_dish_border', 'active_callback' => 'is_front_page','type' => 'checkbox'));
	...
	$wp_customize->add_control( 'fro_top_dish_icon', array('label' => __( "Loop Icon", "frozr"),'section' => 'top_selling_dish','settings' => 'top_dish_icon','active_callback' => 'is_front_page','type' => 'select', 'choices' => $box_icon_array));
	...
	$wp_customize->add_control( new Add_class ( $wp_customize,'fro_top_dish_typo_accord', array('label' => __( ' Typography Options', 'frozr'),'section' => 'top_selling_dish','settings' => 'top_dish_typo_accord','sclass'=>'adv_options','adv'=>true,'fro_attrs'=>array('data-amount'=>'4'),'active_callback' => 'is_front_page')));	
	...
	$wp_customize->add_control( new WP_Customize_Color_Control ( $wp_customize,'fro_top_dish_title_ty_color', array('label' => __( 'Loop title color', 'frozr' ),'section' => 'top_selling_dish','settings' => 'top_dish_title_ty_color','active_callback' => 'is_front_page')));
	...
	$wp_customize->add_control( new WP_Customize_Color_Control ( $wp_customize,'fro_top_dish_desc_ty_color', array('label' => __( 'Loop description color', 'frozr' ),'section' => 'top_selling_dish','settings' => 'top_dish_desc_ty_color','active_callback' => 'is_front_page')));
	//latest restaurants
	...
	$wp_customize->add_control( new Add_class ( $wp_customize, 'fro_show_latest_rests', array('label' => __( "Show Latest Rests?", "frozr"),'section' => 'latest_rests','settings' => 'show_latest_rests', 'sclass' => 'fro_checkbox_option', 'fro_attrs' => array('data-amount'=>'23'), 'active_callback' => 'is_front_page','type' => 'checkbox')));
	...
	$wp_customize->add_control( 'fro_latest_rests_title', array('label' => __( "Loop title", "frozr"),'section' => 'latest_rests','settings' => 'latest_rests_title','active_callback' => 'is_front_page'));
	...
	$wp_customize->add_control( 'fro_latest_rests_desc', array('label' => __( "Loop description", "frozr"),'section' => 'latest_rests','settings' => 'latest_rests_desc','active_callback' => 'is_front_page'));
	...
	$wp_customize->add_control( new Add_class ( $wp_customize,'fro_latest_rests_lyt_accord', array('label' => __( ' Layout Options', 'frozr'),'section' => 'latest_rests','settings' => 'latest_rests_lyt_accord','sclass'=>'adv_options','adv'=>true,'fro_attrs'=>array('data-amount'=>'8'),'active_callback' => 'is_front_page')));	
	fro_background_bund($wp_customize, 'Loop', 'latest_rests', 'is_front_page', '', 'latest_rests_bg_color', 'latest_rests_bg_image', 'latest_rests_bg_repeat', 'latest_rests_bg_position', 'latest_rests_bg_attchment');
	...
	$wp_customize->add_control( 'fro_latest_rests_border', array('label' => __( "Show the loop top border", "frozr"),'section' => 'latest_rests','settings' => 'latest_rests_border', 'active_callback' => 'is_front_page','type' => 'checkbox'));
	...
	$wp_customize->add_control( 'fro_latest_rests_icon', array('label' => __( "Loop Icon", "frozr"),'section' => 'latest_rests','settings' => 'latest_rests_icon','active_callback' => 'is_front_page','type' => 'select', 'choices' => $box_icon_array));
	...
	$wp_customize->add_control( new Add_class ( $wp_customize,'fro_latest_rests_typo_accord', array('label' => __( ' Typography Options', 'frozr'),'section' => 'latest_rests','settings' => 'latest_rests_typo_accord','sclass'=>'adv_options','adv'=>true,'fro_attrs'=>array('data-amount'=>'4'),'active_callback' => 'is_front_page')));	
	...
	$wp_customize->add_control( new WP_Customize_Color_Control ( $wp_customize,'fro_latest_rests_title_ty_color', array('label' => __( 'Loop title color', 'frozr' ),'section' => 'latest_rests','settings' => 'latest_rests_title_ty_color','active_callback' => 'is_front_page')));
	...
	$wp_customize->add_control( new WP_Customize_Color_Control ( $wp_customize,'fro_latest_rests_desc_ty_color', array('label' => __( 'Loop description color', 'frozr' ),'section' => 'latest_rests','settings' => 'latest_rests_desc_ty_color','active_callback' => 'is_front_page')));
}
add_action('customize_register','eater_options');

function lazyeater_output_css() {
...
add_action( 'wp_head' , 'lazyeater_output_css' );