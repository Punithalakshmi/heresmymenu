...
if ( is_woocommerce_active() ) {
	...
	final class Lazy_Eater {
		...
		public function __construct() {
			...
			//add updates
			$updateChecker = new PluginUpdateChecker_3_0('http://updater.mahmudhamid.com/?action=get_metadata&slug=frozr-lazyeater&license_key=opensourcefrozr', lAZY_EATER_FILE, 'frozr-lazyeater');
	 ...
	 * @return void
	 */
	function load_lazy_eater() {

		return Lazy_Eater::init();

	}
	add_action( 'plugins_loaded', 'load_lazy_eater', 5 );
