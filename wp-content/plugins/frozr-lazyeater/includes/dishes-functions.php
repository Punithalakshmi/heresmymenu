...
function edit_add_dish_body($new = false) {
...
<div id="product-edit" class="content-area-product-edit">
	...
	<form class="form" role="form" method="post">
		...
		<div id="edit-product">
			...
			<?php output_dish_data($post_id, $new); ?>
...
<?php }
function output_dish_data( $post_id, $new ) {
...
function output_variations($post_id) {
...
add_action('before_product_archive_loop','filter_product_archive');

//add the location notice to items loops
function dish_location_notice() {
	if(!isset($_COOKIE['frozr_user_location'])) {
		frozr_location_not_set('dish');
	}
}
add_action('before_dishes_list','dish_location_notice');