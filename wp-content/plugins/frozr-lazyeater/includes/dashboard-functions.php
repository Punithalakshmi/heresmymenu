...
//Dashboard sidebar
function dash_sidebar($active_menu) {
...
add_action('frozr_dash_sidebar', 'dash_sidebar', 1);

//Dashboard Total Sales
function dash_total_sales( $type = 'today', $start = '', $end = '', $user = '' ) {
	$website_fee = array();
	...
	foreach ($order_ids as $order_id) {
		...
		$percentage = (is_super_admin()) ? 100 - frozr_get_seller_percentage( $order_id->post_author ) : frozr_get_seller_percentage( $order_id->post_author );
		$website_profit = ('' != get_post_meta($order_id->ID, 'frozr_order_website_fee', true)) ? get_post_meta($order_id->ID, 'frozr_order_website_fee', true) : (floatval(frozr_get_seller_total_order($order)) * $percentage ) / 100;
...
function frozr_dashboard_totals( $type = 'today', $start = '', $end = '', $user = '' ) {
	$totals = dash_total_sales( $type, $start, $end, $user );
	?>
	...
	<div class="dash_totals f-black">
		...
		<tr>
			...
			<td class="dast_pcount">
				<?php echo count_user_object('wc-completed', 'shop_order'); ?>
			</td>
		</tr>
		<tr>
			<td class="dast_dico">
			...
			<td class="dast_pcount">
				<?php echo count_user_object('wc-pending', 'shop_order'); ?>
			</td>
		</tr>
		<tr>
			<td class="dast_dico">
			...
			<td class="dast_pcount">
				<?php echo count_user_object('wc-processing', 'shop_order'); ?>
			</td>
		</tr>
		<tr>
			<td class="dast_dico">
			...
			<td class="dast_pcount">
				<?php echo count_user_object('wc-cancelled', 'shop_order'); ?>
			</td>
		</tr>
		<tr>
			<td class="dast_dico">
			...
			<td class="dast_pcount">
				<?php echo count_user_object('wc-refunded', 'shop_order'); ?>
			</td>
		</tr>
		<tr>
			<td class="dast_dico">
			...
			<td class="dast_pcount">
				<?php echo count_user_object('wc-on-hold', 'shop_order'); ?>
			</td>
		</tr>
		</tbody>
		</table>
